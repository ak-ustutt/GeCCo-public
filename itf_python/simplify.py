...
def factor_out(clist,f2):
    ...
    # not needed any more, we use autogenerated symbol
    ...
    for ii in range(len(clist)):
        ...
        if not equal:
            #if (idx>=len(symbols)):
            #    print("Programming restriction: Extend symbol list!",file=f2)
            #    quit()
            symlist[ii][1] = 'OP'+str(idx) # symbols[idx]
            trans_dict[symlist[ii][1]] = [clist[ii][1],clist[ii][2]]
            idx = idx+1
    ...
    for ii in range(len(clist)):
        ...
        if not equal:
            ...
            #    print("Programming restriction: Extend symbol list!",file=f2)
            #    quit()
            symlist[ii][2] = 'OP'+str(idx) # symbols[idx]
            trans_dict[symlist[ii][2]] = [clist[ii][3],clist[ii][4]]
            idx = idx+1
