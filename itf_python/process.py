...
if (multi):
    print(file=f2)
    print("// Tensors needed to construct fock matrices",file=f2)
    print("tensor: h:aa[pq], fc:aa", file=f2)
    print("tensor: h:cc[ki], fc:cc", file=f2)
    print("tensor: h:ea[aq], fc:ea", file=f2)
    print("tensor: h:ec[ai], fc:ec", file=f2)
    print("tensor: h:ee[ab], fc:ee", file=f2)
    print("tensor: h:ca[ip], fc:ca", file=f2)
    print("", file=f2)
...
if (multi):
    ...
    print("load h:ca[**]", file=f2)
    print(".f:ac[pi] := h:ca[ip]", file=f2)
    print("drop h:ca[**]", file=f2)
    print("load deltacc[**], J:ccca[****]", file=f2)
    print(".f:ac[pi] += 2.*deltacc[kj] J:ccca[jkip]", file=f2)
    print(".f:ac[pi] -= deltacc[kj] J:ccca[ikjp]", file=f2)
    print("drop J:ccca[****], deltacc[**]", file=f2)
    print("store f:ac[**]", file=f2)
    print("", file=f2)
    print("alloc f:ec[**]", file=f2)
    print("load h:ec[**]", file=f2)
    print(".f:ec[ai] += h:ec[ai]", file=f2)
    print("drop h:ec[**]", file=f2)
    print("load deltacc[**], J:eccc[****]", file=f2)
    print(".f:ec[ai] += 2.*deltacc[kj] J:eccc[aijk]", file=f2)
    print(".f:ec[ai] -= deltacc[kj] J:eccc[ajik]", file=f2)
    print("drop J:eccc[****], deltacc[**]", file=f2)
    print("store f:ec[**]", file=f2)
    print("", file=f2)
    print("alloc f:cc[**]", file=f2)
    print("load h:cc[**]", file=f2)
    print(".f:cc[ij] := h:cc[ij]", file=f2)
    print("drop h:cc[**]", file=f2)
    print("load deltacc[**], K:cccc[****]", file=f2)
    print(".f:cc[ij] += 2.*deltacc[lk] K:cccc[jkil]", file=f2)
    print(".f:cc[ij] -= deltacc[lk] K:cccc[jkli]", file=f2)
    print("drop K:cccc[****], deltacc[**]", file=f2)
    print("store f:cc[**]", file=f2)
    print("", file=f2)
    print("alloc f:ea[**]", file=f2)
    print("load h:ea[**]", file=f2)
    print(".f:ea[ap] := h:ea[ap]", file=f2)
    print("drop h:ea[**]", file=f2)
    print("load deltacc[**]", file=f2)
    print("load J:eacc[****]", file=f2)
    print(".f:ea[ap] += 2.*deltacc[ji] J:eacc[apij]", file=f2)
    print("drop J:eacc[****]", file=f2)
    print("load J:ecca[****]", file=f2)
    print(".f:ea[ap] -= deltacc[ji] J:ecca[ajip]", file=f2)
    print("drop J:ecca[****]", file=f2)
    print("drop deltacc[**]", file=f2)
    print("store f:ea[**]", file=f2)
    print("", file=f2)
    print("alloc f:ee[**]", file=f2)
    print("load h:ee[**]", file=f2)
    print(".f:ee[ab] := h:ee[ab]", file=f2)
    print("drop h:ee[**]", file=f2)
    print("load deltacc[**]", file=f2)
    print("load J:eecc[****]", file=f2)
    print(".f:ee[ab] += 2.*deltacc[ji] J:eecc[baij]", file=f2)
    print("drop J:eecc[****]", file=f2)
    print("load K:eecc[****]", file=f2)
    print(".f:ee[ab] -= deltacc[ji] K:eecc[baji]", file=f2)
    print("drop K:eecc[****]", file=f2)
    print("drop deltacc[**]", file=f2)
    print("store f:ee[**]", file=f2)
    print("", file=f2)
    print("alloc f:aa[**]", file=f2)
    print("load h:aa[**]", file=f2)
    print(".f:aa[pq] := h:aa[pq]", file=f2)
    print("drop h:aa[**]", file=f2)
    print("load deltacc[**]", file=f2)
    print("load J:ccaa[****]", file=f2)
    print(".f:aa[pq] += 2.*deltacc[ji] J:ccaa[ijqp]", file=f2)
    print("drop J:ccaa[****]", file=f2)
    print("load K:ccaa[****]", file=f2)
    print(".f:aa[pq] -= deltacc[ji] K:ccaa[jiqp]", file=f2)
    print("drop K:ccaa[****]", file=f2)
    print("drop deltacc[**]", file=f2)
    ...
    print(".g:ac[pi] += J:caaa[ipqr] Dm1[qr]", file=f2)
    print(".g:ac[pi] -= .5*J:caaa[irqp] Dm1[qr]", file=f2)
    ...
    print("load J:ecaa[****]", file=f2)
    print(".g:ec[ai] += J:ecaa[aipq] Dm1[pq]", file=f2)
    print("drop J:ecaa[****]", file=f2)
    print("load K:ecaa[****]", file=f2)
    print(".g:ec[ai] -= .5*K:ecaa[aipq] Dm1[pq]", file=f2)
    print("drop K:ecaa[****]", file=f2)
    ...
    print("load Dm1[**]", file=f2)
    print("load J:ccaa[****]", file=f2)
    print(".g:cc[ij] += J:ccaa[jipq] Dm1[pq]", file=f2)
    print("drop J:ccaa[****]", file=f2)
    print("load K:ccaa[****]", file=f2)
    print(".g:cc[ij] -= .5*K:ccaa[jiqp] Dm1[pq]", file=f2)
    print("drop K:ccaa[****]", file=f2)
    print("drop Dm1[**]", file=f2)
    ...
    print(".g:ea[ap] += J:eaaa[apqr] Dm1[qr]", file=f2)
    print(".g:ea[ap] -= .5*J:eaaa[arqp] Dm1[qr]", file=f2)
    ...
    print("load Dm1[**]", file=f2)
    print("load J:eeaa[****]", file=f2)
    print(".g:ee[ab] += J:eeaa[bapq] Dm1[pq]", file=f2)
    print("drop J:eeaa[****]", file=f2)
    print("load K:eeaa[****]", file=f2)
    print(".g:ee[ab] -= .5*K:eeaa[baqp] Dm1[pq]", file=f2)
    print("drop K:eeaa[****]", file=f2)
    print("drop Dm1[**]", file=f2)
    ...
    print("load Dm1[**]", file=f2)
    print(".g:aa[pq] += K:aaaa[qrps] Dm1[rs]", file=f2)
    print(".g:aa[pq] -= .5*K:aaaa[qrsp] Dm1[rs]", file=f2)
    print("drop Dm1[**]", file=f2)
...
if (not multi):
    ...
    print("drop f:cc[ii], f:aa[pp]", file=f2)
    print("load OT:aacc[pqij]", file=f2)
    ...
    print("drop f:cc[ii], f:aa[pp]", file=f2)
    print("load OT:aaac[pqri]", file=f2)
    ...
    print("load OT:eacc[apij]", file=f2)
    ...
    print("drop f:cc[ii], f:aa[pp], f:ee[aa]", file=f2)
    print("load OT:eaac[apqi]", file=f2)
    ...
    print("drop f:aa[pp], f:ee[aa]", file=f2)
    print("load OT:eaaa[apqr]", file=f2)
    ...
    print("drop f:cc[ii], f:ee[aa]", file=f2)
    print("load OT:eecc[abij]", file=f2)
    ...
    print("drop f:cc[ii], f:aa[pp], f:ee[aa]", file=f2)
    print("load OT:eeac[abpi]", file=f2)
    ...
    print("drop f:aa[pp], f:ee[aa]", file=f2)
    print("load OT:eeaa[abpq]", file=f2)
