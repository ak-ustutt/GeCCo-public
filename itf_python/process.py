...
if (multi):
    ...
    print("tensor: I1[pppp], !Create{type:plain}", file=f2)
    print("tensor: I2[pppp], !Create{type:plain}", file=f2)
    print("tensor: I3[pppppp], !Create{type:plain}", file=f2)
    print(file=f2)
    ...
    print("tensor: OR:eaca[apiq], OR:eaca", file=f2)
    ...
    print("tensor: OT:eaca[apiq], OT:eaca", file=f2)
...
if (not multi):
...
else: # unclear if the code generated below is ever executed ... provide a comment in itfaa file!
    ...
    print("// sign flip as R is formally {V}{P} while T is {PV}", file=f2)
    ...
    print("// sign flip as R is formally {V}{VVH} while T is {VVHV}", file=f2)
    ...
    print("// sign flip as R is formally {V}{PVH} while T is {PVHV}", file=f2)
    ...
    print("// sign flip as R is formally {V}{PPH} while T is {PPHV}", file=f2)
...
if (multi):
    ...
    print('---- code("Transform_Residual")', file=f2)
    print("// I1", file=f2)
    print("alloc OR:ac[pi]", file=f2)
    print("load R:ac[pi], S1:I1[pq]", file=f2)
    print(".OR:ac[qi] += R:ac[pi] S1:I1[pq]", file=f2)
    print("drop S1:I1[pq], R:ac[pi]", file=f2)
    print("store OR:ac[pi]", file=f2)
    print("", file=f2)
    print("alloc OR:aaac[pqri]", file=f2)
    print("load R:aaac[pqri], S2:I1[pqrstu]", file=f2)
    print(".OR:aaac[stui] += R:aaac[pqri] S2:I1[pqrstu]", file=f2)
    print("drop S2:I1[pqrstu], R:aaac[pqri]", file=f2)
    print("store OR:aaac[pqri]", file=f2)
    print("", file=f2)
    print("// I2", file=f2)
    print("alloc OR:aacc[pqij]", file=f2)
    print("load R:aacc[pqij], S2:I2[pqrs]", file=f2)
    print(".OR:aacc[rsij] += R:aacc[pqij] S2:I2[pqrs]", file=f2)
    print("drop S2:I2[pqrs], R:aacc[pqij]", file=f2)
    print("store OR:aacc[pqij]", file=f2)
    print("", file=f2)
    print("// S0", file=f2)
    print("alloc OR:ea[ap]", file=f2)
    print("load R:ea[ap], S1:S0[pq]", file=f2)
    print(".OR:ea[aq] += R:ea[ap] S1:S0[pq]", file=f2)
    print("drop S1:S0[pq], R:ea[ap]", file=f2)
    print("store OR:ea[ap]", file=f2)
    print("", file=f2)
    print("// S1", file=f2)
    print("alloc OR:eaca[apiq]", file=f2)
    print("load R:eaca[apiq], S2:S1[pqrs]", file=f2)
    print(".OR:eaca[aris] += R:eaca[apiq] S2:S1[pqrs]", file=f2)
    print("drop S2:S1[pqrs], R:eaca[apiq]", file=f2)
    print("store OR:eaca[apiq]", file=f2)
    print("", file=f2)
    print("alloc OR:eaac[apqi]", file=f2)
    print("load R:eaac[apqi], S2:S1[pqrs]", file=f2)
    print(".OR:eaac[arsi] += R:eaac[apqi] S2:S1[pqrs]", file=f2)
    print("drop S2:S1[pqrs], R:eaac[apqi]", file=f2)
    print("store OR:eaac[apqi]", file=f2)
    print("", file=f2)
    print("// S2", file=f2)
    print("alloc OR:eacc[apij]", file=f2)
    print("load R:eacc[apij], S2:S2[pq]", file=f2)
    print(".OR:eacc[aqij] += R:eacc[apij] S2:S2[pq]", file=f2)
    print("drop S2:S2[pq], R:eacc[apij]", file=f2)
    print("store OR:eacc[apij]", file=f2)
    print("", file=f2)
    print("// P0", file=f2)
    print("alloc OR:eeaa[abpq]", file=f2)
    print("load R:eeaa[abpq], S2:P0[pqrs]", file=f2)
    print(".OR:eeaa[abrs] += R:eeaa[abpq] S2:P0[pqrs]", file=f2)
    print("drop S2:P0[pqrs], R:eeaa[abpq]", file=f2)
    print("store OR:eeaa[abpq]", file=f2)
    print("", file=f2)
    print("// P1", file=f2)
    print("alloc OR:eeac[abpi]", file=f2)
    print("load R:eeac[abpi], S2:P1[pq]", file=f2)
    print(".OR:eeac[abqi] += R:eeac[abpi] S2:P1[pq]", file=f2)
    print("drop S2:P1[pq], R:eeac[abpi]", file=f2)
    print("store OR:eeac[abpi]", file=f2)
    print("", file=f2)
    print("", file=f2)
    # this seems to be the currently active code ... provide a comment on this in itfaa file
    print('---- code("Create_Amplitude_Update")', file=f2)
    print("alloc Var1[]", file=f2)
    print("", file=f2)
    print("load OR:ac[pi]", file=f2)
    print("load A1[pp], gminus[ii]", file=f2)
    print("denom-scale OR:ac[pi], A1[pp] + gminus[ii]", file=f2)
    print("drop gminus[ii], A1[pp]", file=f2)
    print("alloc OT:ac[pi]", file=f2)
    print(".OT:ac[pi] -= OR:ac[pi]", file=f2)
    print("store OT:ac[pi]", file=f2)
    print(".Var1[] += 2.0*OR:ac[pi] OR:ac[pi]", file=f2)
    ...
    print("", file=f2)
    print("load OR:ea[ap]", file=f2)
    print("load g:ee[aa], A4[pp]", file=f2)
    print("denom-scale OR:ea[ap], g:ee[aa] - A4[pp]", file=f2)
    print("drop A4[pp], g:ee[aa]", file=f2)
    print("alloc OT:ea[ap]", file=f2)
    print("// sign flip as R is formally {V}{P} while T is {PV}", file=f2)
    print("//.OT:ea[ap] -= OR:ea[ap]", file=f2)
    print(".OT:ea[ap] += OR:ea[ap]", file=f2)
    ...
    print("alloc Var2[]", file=f2)
    print("load OR:aacc[pqij]", file=f2)
    print("load A1[pp], g:cc[ii]", file=f2)
    print("denom-scale OR:aacc[pqij], A1[pp] + A1[qq] - g:cc[ii] - g:cc[jj]", file=f2)
    print("drop g:cc[ii], A1[pp]", file=f2)
    print("alloc OT:aacc[pqij]", file=f2)
    print(".OT:aacc[pqij] -= OR:aacc[pqij]", file=f2)
    print("store OT:aacc[pqij]", file=f2)
    print(".Var2[] += (2.0*OR:aacc[pqij] - OR:aacc[qpij]) OR:aacc[pqij]", file=f2)
    ...
    print("", file=f2)
    print("load OR:aaac[pqri]", file=f2)
    print("load g:aa[pp], g:cc[ii]", file=f2)
    print("denom-scale OR:aaac[pqri], g:aa[pp] + g:aa[qq] - g:aa[rr] - g:cc[ii]", file=f2)
    print("drop g:cc[ii], g:aa[pp]", file=f2)
    print("alloc OT:aaac[pqri]", file=f2)
    print("// sign flip as R is formally {V}{VVH} while T is {VVHV}", file=f2)
    print("//.OT:aaac[pqri] -= OR:aaac[pqri]", file=f2)
    print(".OT:aaac[pqri] += OR:aaac[pqri]", file=f2)
    ...
    print("", file=f2)
    print("load OR:eacc[apij]", file=f2)
    print("load g:ee[aa], A1[pp], g:cc[ii]", file=f2)
    print("denom-scale OR:eacc[apij], g:ee[aa] + A1[pp] - g:cc[ii] - g:cc[jj]", file=f2)
    print("drop g:cc[ii], A1[pp], g:ee[aa]", file=f2)
    print("alloc OT:eacc[apij]", file=f2)
    print(".OT:eacc[apij] -= OR:eacc[apij]", file=f2)
    print("store OT:eacc[apij]", file=f2)
    print(".Var2[] += OR:eacc[apij] OR:eacc[apij]", file=f2)
    ...
    print("", file=f2)
    print("load OR:eaac[apqi]", file=f2)
    print("load g:ee[aa], gminus[ii]", file=f2)
    print("denom-scale OR:eaac[apqi], g:ee[aa] + gminus[ii]", file=f2)
    print("drop gminus[ii], g:ee[aa]", file=f2)
    print("alloc OT:eaac[apqi]", file=f2)
    print("// sign flip as R is formally {V}{PVH} while T is {PVHV}", file=f2)
    print("//.OT:eaac[apqi] -= OR:eaac[apqi]", file=f2)
    print(".OT:eaac[apqi] += OR:eaac[apqi]", file=f2)
    ...
    print("drop OR:eaac[apqi]", file=f2)
    print("", file=f2)
    print("load OR:eaca[apiq]", file=f2)
    print("load g:ee[aa], gminus[ii]", file=f2)
    print("denom-scale OR:eaca[apiq], g:ee[aa] + gminus[ii]", file=f2)
    print("drop gminus[ii], g:ee[aa]", file=f2)
    print("alloc OT:eaca[apiq]", file=f2)
    print(".OT:eaca[apiq] -= OR:eaca[apiq]", file=f2)
    print("store OT:eaca[apiq]", file=f2)
    print(".Var2[] += OR:eaca[apiq] OR:eaca[apiq]", file=f2)
    print("drop OR:eaca[apiq]", file=f2)
    print("", file=f2)
    print("load OR:eaaa[apqr]", file=f2)
    print("load g:ee[aa], g:aa[pp]", file=f2)
    print("denom-scale OR:eaaa[apqr], g:ee[aa] + g:aa[pp] - g:aa[qq] - g:aa[rr]", file=f2)
    print("drop g:aa[pp], g:ee[aa]", file=f2)
    print("alloc OT:eaaa[apqr]", file=f2)
    print(".OT:eaaa[apqr] -= OR:eaaa[apqr]", file=f2)
    print("store OT:eaaa[apqr]", file=f2)
    print(".Var2[] += OR:eaaa[apqr] OR:eaaa[apqr]", file=f2)
    ...
    print("", file=f2)
    print("load OR:eeac[abpi]", file=f2)
    print("load g:ee[aa], g:cc[ii], A4[pp]", file=f2)
    print("denom-scale OR:eeac[abpi], g:ee[aa] + g:ee[bb] - A4[pp] - g:cc[ii]", file=f2)
    print("drop A4[pp], g:cc[ii], g:ee[aa]", file=f2)
    print("alloc OT:eeac[abpi]", file=f2)
    print("// sign flip as R is formally {V}{PPH} while T is {PPHV}", file=f2)
    print("//.OT:eeac[abpi] -= OR:eeac[abpi]", file=f2)
    print(".OT:eeac[abpi] += OR:eeac[abpi]", file=f2)
    ...
    print("load OR:eeaa[abpq]", file=f2)
    print("load g:ee[aa], g:aa[pp]", file=f2)
    print("denom-scale OR:eeaa[abpq], g:ee[aa] + g:ee[bb] - g:aa[pp] - g:aa[qq]", file=f2)
    print("drop g:aa[pp], g:ee[aa]", file=f2)
    print("alloc OT:eeaa[abpq]", file=f2)
    print(".OT:eeaa[abpq] -= OR:eeaa[abpq]", file=f2)
    print("store OT:eeaa[abpq]", file=f2)
    ...
    print("", file=f2)
    print("", file=f2)
    print('---- code("Construct_GS_Overlap")', file=f2)
    print("// Construct overlap blocks of S1 and S2 parts which", file=f2)
    print("// don't involve orthogonalisation to S1 parts", file=f2)
    print("", file=f2)
    print("// I1", file=f2)
    print("alloc S1:I1[pq]", file=f2)
    print("load Dm1H[pq]", file=f2)
    ...
    print("", file=f2)
    print("", file=f2)
    print('---- code("Construct_S2")', file=f2)
    print("// Set up overlap metric, ready to construct X used", file=f2)
    print("// in sequential orthogonalisation", file=f2)
    print("", file=f2)
    print("// I1", file=f2)
    ...
    print('---- code("Update_Amplitudes")', file=f2)
    print("// I1", file=f2)
    print("alloc Nrm1[]", file=f2)
    print("load T:ac[pi]", file=f2)
    print("load OT:ac[pi], S1:I1[pq]", file=f2)
    print(".T:ac[qi] += OT:ac[pi] S1:I1[pq]", file=f2)
    print(".Nrm1[] += 2.*T:ac[pi] T:ac[pi]", file=f2)
    print("drop S1:I1[pq], OT:ac[pi]", file=f2)
    print("store T:ac[pi]", file=f2)
    print("store Nrm1[]", file=f2)
    print("", file=f2)
    print("alloc Nrm2[]", file=f2)
    print("load T:aaac[pqri]", file=f2)
    print("load OT:aaac[pqri], S2:I1[pqrstu]", file=f2)
    print(".T:aaac[stui] += OT:aaac[pqri] S2:I1[pqrstu]", file=f2)
    print(".Nrm2[] += T:aaac[pqri] T:aaac[pqri]", file=f2)
    print("drop S2:I1[pqrstu], OT:aaac[pqri]", file=f2)
    print("store T:aaac[pqri]", file=f2)
    print("store Nrm2[]", file=f2)
    print("", file=f2)
    print("// I2", file=f2)
    print("load Nrm2[]", file=f2)
    print("load T:aacc[pqij]", file=f2)
    print("load OT:aacc[pqij], S2:I2[pqrs]", file=f2)
    print(".T:aacc[rsij] += OT:aacc[pqij] S2:I2[pqrs]", file=f2)
    print(".Nrm2[] += (2.*T:aacc[pqij] - T:aacc[pqij]) T:aacc[pqij]", file=f2)
    print("drop S2:I2[pqrs], OT:aacc[pqij]", file=f2)
    print("store T:aacc[pqij]", file=f2)
    print("store Nrm2[]", file=f2)
    print("", file=f2)
    print("// S0", file=f2)
    print("load Nrm1[]", file=f2)
    print("load T:ea[ap]", file=f2)
    print("load OT:ea[ap], S1:S0[pq]", file=f2)
    print(".T:ea[aq] += OT:ea[ap] S1:S0[pq]", file=f2)
    print(".Nrm1[] += 2.*T:ea[ap] T:ea[ap]", file=f2)
    print("drop S1:S0[pq], OT:ea[ap]", file=f2)
    ...
    print("// S2", file=f2)
    print("", file=f2)
    print("load Var1[]", file=f2)
    print("load R:ec[ai]", file=f2)
    print("load g:ee[aa], g:cc[ii]", file=f2)
    print("denom-scale R:ec[ai], g:ee[aa] - g:cc[ii]", file=f2)
    print("drop g:cc[ii], g:ee[aa]", file=f2)
    print("load T:ec[ai]", file=f2)
    print(".T:ec[ai] -= R:ec[ai]", file=f2)
    print(".Nrm1[] += 2.*T:ec[ai] T:ec[ai]", file=f2)
    print("store T:ec[ai]", file=f2)
    print(".Var1[] += 2.*R:ec[ai] R:ec[ai]", file=f2)
    print("drop R:ec[ai]", file=f2)
    print("store Var1[]", file=f2)
    print("store Nrm1[]", file=f2)
    print("", file=f2)
    ...
    print("load Nrm2[]", file=f2)
    print("", file=f2)
    print("load T:eaca[apiq]", file=f2)
    print("load OT:eaca[apiq], S2:S1[pqrs]", file=f2)
    print(".T:eaca[aris] += OT:eaca[apiq] S2:S1[prqs]", file=f2)
    print(".Nrm2[] += T:eaca[apiq] T:eaca[apiq]", file=f2)
    print("drop S2:S1[pqrs], OT:eaca[apiq]", file=f2)
    print("store T:eaca[apiq]", file=f2)
    print("", file=f2)
    print("load T:eaac[apqi]", file=f2)
    print("load OT:eaac[apqi], S2:S1[pqrs]", file=f2)
    print(".T:eaac[arsi] += OT:eaac[apqi] S2:S1[pqrs]", file=f2)
    print(".Nrm2[] += T:eaac[apqi] T:eaac[apqi]", file=f2)
    print("drop S2:S1[pqrs], OT:eaac[apqi]", file=f2)
    print("store T:eaac[apqi]", file=f2)
    print("", file=f2)
    print("load T:eacc[apij]", file=f2)
    print("load OT:eacc[apij], S2:S2[pq]", file=f2)
    print(".T:eacc[aqij] += OT:eacc[apij] S2:S2[pq]", file=f2)
    print(".Nrm2[] += T:eacc[apij] T:eacc[apij]", file=f2)
    print("drop S2:S2[pq], OT:eacc[apij]", file=f2)
    print("store T:eacc[apij]", file=f2)
    print("", file=f2)
    print("// P0", file=f2)
    print("load T:eeaa[abpq]", file=f2)
    print("load OT:eeaa[abpq], S2:P0[pqrs]", file=f2)
    print(".T:eeaa[abrs] += OT:eeaa[abpq] S2:P0[pqrs]", file=f2)
    print(".Nrm2[] += (2.*T:eeaa[abpq] - T:eeaa[bapq]) T:eeaa[abpq]", file=f2)
    print("drop S2:P0[pqrs], OT:eeaa[abpq]", file=f2)
    print("store T:eeaa[abpq]", file=f2)
    print("", file=f2)
    print("// P1", file=f2)
    print("load T:eeac[abpi]", file=f2)
    print("load OT:eeac[abpi], S2:P1[pq]", file=f2)
    print(".T:eeac[abqi] += OT:eeac[abpi] S2:P1[pq]", file=f2)
    print(".Nrm2[] += T:eeac[abpi] T:eeac[abpi]", file=f2)
    print("drop S2:P1[pq], OT:eeac[abpi]", file=f2)
    print("store T:eeac[abpi]", file=f2)
    print("", file=f2)
    print("// P2", file=f2)
    print("", file=f2)
    print("", file=f2)
    print("load Var2[]", file=f2)
    print("load R:eecc[abij]", file=f2)
    print("load g:ee[aa], g:cc[ii]", file=f2)
    print("denom-scale R:eecc[abij], g:ee[aa] + g:ee[bb] - g:cc[ii] - g:cc[jj]", file=f2)
    print("drop g:cc[ii], g:ee[aa]", file=f2)
    print("load T:eecc[abij]", file=f2)
    print(".T:eecc[abij] -= R:eecc[abij]", file=f2)
    print(".Nrm2[] += (2.*T:eecc[abij] - T:eecc[baij]) T:eecc[abij]", file=f2)
    print("store T:eecc[abij]", file=f2)
    print(".Var2[] += (2.*R:eecc[abij] - R:eecc[baij]) R:eecc[abij]", file=f2)
    ...
    print("", file=f2)
    print("", file=f2)
    print('---- code("Construct_Projected_S2")', file=f2)
    print("// Set up overlap metric, ready to construct X used", file=f2)
    print("// in sequential orthogonalisation", file=f2)
    print("", file=f2)
    print("// I1", file=f2)
    ...
    print("store S3:I1[pqrs]", file=f2)
    print("", file=f2)
    print("alloc I1[pqrs], I2[pqrs]", file=f2)
    print("load S1:I1[pq], S3:I1[pqrs]", file=f2)
    print(".I1[pqts] += S3:I1[qpsr] S1:I1[rt]", file=f2)
    print(".I2[pqts] += S3:I1[pqrs] S1:I1[tr]", file=f2)
    print("drop S3:I1[pqrs], S1:I1[pq]", file=f2)
    print("alloc I3[pqrstu]", file=f2)
    print(".I3[pqrstu] += I1[pvst] I2[qrvu]", file=f2)
    print("alloc S2:I1[pqrstu]", file=f2)
    print("load Dm3[pppppp], Dm2[pppp], Dm1[pp], deltaaa[pp]", file=f2)
    print(".S2:I1[pqrstu] := Dm3[pqrstu]", file=f2)
    print(".S2:I1[pqrstu] -= deltaaa[pt] Dm2[rqsu]", file=f2)
    ...
    print(".S2:I1[pqrstu] -= delta4[qptu] Dm1[rs]", file=f2)
    print("drop delta4[pppp]", file=f2)
    print(".S2:I1[pqrstu] -= I3[pqrstu]", file=f2)
    print("drop deltaaa[pp], Dm1[pp], Dm2[pppp], Dm3[pppppp]", file=f2)
    print("store S2:I1[pqrstu]", file=f2)
    print("drop I3[pqrstu]", file=f2)
    print("drop I2[pqrs], I1[pqrs]", file=f2)
    print("", file=f2)
    print("", file=f2)
    print("// S0", file=f2)
    print("alloc S3:S0[pqrs]", file=f2)
