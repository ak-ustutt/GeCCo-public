...
if method in ["CEPT2","CCEPA"]:
   singles = 0
if method in ["CEPT20","CEPT21","CEPT22","CEPT23","CEPT24","CEPT25","CEPT26","CEPT27","CCEPA0","CCEPA1","CCEPA2","CCEPA3","CCEPA4","CCEPA5","CCEPA6","CCEPA7"]:
...
known_methods=["Yuri", "MRCCSD22", "CEPT2","CCEPA","BETACEPT2","CEPA0","CEPA0TeTi","PT2","BETACCEPA","SPLITCEPT2","SPLITCCEPA"]
...
# Select H0
if method in ['CEPT2','BETACEPT2','PT2','SPLITCEPT2','SPLITCCEPA']:
...
#--------------
#CIPT2 seperation ?
#ti_shape='VV,VH|VV,HH|PV,HV|PV,HH|PP,HH|V,H|P,H|PP,HV'
#--------------
...
if method in ['CEPT2','CCEPA','BETACEPT2','CEPA0TeTi','BETACCEPA','SPLITCEPT2','SPLITCCEPA']: #TeTistuff
   def _Le_refexp(x):
...
if method=='MRCCSD22':
    ...
    if singles == 0: 
       ...
       if hamiltonian == "DYALL":
          LAG_A2.append(_Ls_refexp("(H-ECEPA)*Ts"))
          LAG_A1.append(_Ls_refexp("(["+_h0_+",Ti])"))
          LAG_A2.append(_Ls_refexp("(H-ECEPA)*Te"))
