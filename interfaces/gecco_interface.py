...
_list_bool_arg = ['NEW']
_list_str_arg = ['STRING','MODE','TITLE']
...
# names... Do we really need OPERATOR and OPERATORS, or LABEL_IN
# and LABELS_IN...
#

# Functions for rules
rules_names_file = "/Users/yuriaoto/Documents/Codes/GeCCo/interfaces/rules_names.txt"

f = open( rules_names_file, 'r')
rules = f.readlines()
f.close()
for r in rules:
    exec ('def ' + r.strip() + ' ( arguments):\n\trule("' + r.strip() + '", arguments)')


# Variables for arguments
arguments_names_file = "/Users/yuriaoto/Documents/Codes/GeCCo/interfaces/arguments_names.txt"

f = open( arguments_names_file, 'r')
variables = f.readlines()
f.close()
for v in variables:
    exec (v.strip() + ' = "' + v.strip() + '"')
