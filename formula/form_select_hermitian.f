*----------------------------------------------------------------------*
      subroutine form_select_hermitian(f_output,f_input,
     &                      title,label_opres,
     &                      op_info)
*----------------------------------------------------------------------*
*     select self-adjoint terms
*     driver routine for select_hermitian()
*
*     adapted from form_sum_hermite by matthias, fall 2009
*----------------------------------------------------------------------*
      implicit none
     ...
     &       'here speaks form_select_hermitian')
      ...
      if (idxres.lt.0)
     &     call quit(1,'form_select_hermitian',
     ...
     &       trim(label_opres))
      ...
      call select_hermitian(flist,op_info)
