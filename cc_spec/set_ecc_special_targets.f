...
*----------------------------------------------------------------------*
      ...
      call set_dependency(form_cclg0,op_ecclg,tgt_info)
      ...
      call set_rule(form_cclg0,ttype_frm,DEF_ECC_LAGRANGIAN,
     &              labels,5,1,
     &              title_cclg0,1,tgt_info)
      ...
      call set_dependency(form_eccrs0_t,form_cclg0,tgt_info)
      call set_dependency(form_eccrs0_t,op_omg,tgt_info)
     ...
     &              title_eccrs0_t,1,tgt_info)
      ...
      call set_dependency(form_eccrs0_l,form_cclg0,tgt_info)
      call set_dependency(form_eccrs0_l,op_omg,tgt_info)
...
*----------------------------------------------------------------------*
      ...
      ! L0/E0: 
      call add_target(mel_ecclg0,ttype_opme,.false.,tgt_info)
      call set_dependency(mel_ecclg0,op_ecclg,tgt_info)
      labels(1:10)(1:len_target_name) = ' '
      labels(1) = mel_ecclg0
      labels(2) = op_ecclg
      call me_list_parameters(-1,parameters,
     &     0,0,1,0,0)
      call set_rule(mel_ecclg0,ttype_opme,DEF_ME_LIST,
     &              labels,2,1,
     &              parameters,1,tgt_info)
