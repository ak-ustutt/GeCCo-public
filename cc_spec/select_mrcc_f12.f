...
*----------------------------------------------------------------------*
     ...
     &     idx_oplist2, iblk_occ, idxlist
      ...
      if (ntest.ge.100) then
        call write_title(luout,wst_dbg_subr,'select_mrcc_f12')
      endif
      ...
      if (error) then
        ...
        if (nlabels.ne.5)
     &       call quit(1,'select_mrcc_f12','need exactly 3 labels')
