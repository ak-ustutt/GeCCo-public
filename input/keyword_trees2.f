...
*----------------------------------------------------------------------*
     ...
     &   context
      ...
      new_parent=> tree_key_from_context(tree,trim(context),
     &     latest=.True.)
...
*----------------------------------------------------------------------*
     ...
     &     level
      ...
      if (associated(child))then
         ...
         up_loop: do 
            nxtkey => elem_getParentNode(nxtkey)  ! makes problems if there are non element nodes in the tree.
            level=level-1 ! 
            if (level .eq. 0) then
            ...
            sibling=>elem_getNextSibling(nxtkey)
...
*----------------------------------------------------------------------*
     ...
     &     ikeycount,iargcount
      ...
      finode=> arg_from_context(context,name,tree%root,latest,
     &     ikeycount,iargcount)
      end function
...
*----------------------------------------------------------------------*
     ...
     &     ilatest
      ...
      finode=> key_from_context(context,tree%root,latest,
     &     ikeycount)
      end function
*----------------------------------------------------------------------*
