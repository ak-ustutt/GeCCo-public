*----------------------------------------------------------------------*
      subroutine import_fock_molpro_ifc(lumoint,ifpos,
     &     hlist,ecore,fock,nfock,
     &     str_info,orb_info)
*----------------------------------------------------------------------*
*     read fock operator from molpro interface file
...
*----------------------------------------------------------------------*
     ...
     &     xh1reo(:)
      ...
      if (ntest.ge.100)
     &    call write_title(lulog,wst_dbg_subr,'import_fock_molpro_ifc')
     ...
     &       call quit(1,'import_fock_molpro_ifc',
