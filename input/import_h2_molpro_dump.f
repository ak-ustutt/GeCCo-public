*----------------------------------------------------------------------*
      subroutine import_h2_molpro_dump(ludump,hlist,fock,nfock,
     &     str_info,orb_info)
*----------------------------------------------------------------------*
*     read through FCIDUMP file and sort integral into list hlist;
