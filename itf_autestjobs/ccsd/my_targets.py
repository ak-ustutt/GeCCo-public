...
CLONE_OPERATOR({LABEL:'INTpp',TEMPLATE:'T2'})
...
EXPAND_OP_PRODUCT({LABEL:'CCD_FORM_PP',NEW:True,OP_RES:'INTpp',FAC:0.5,
                   OPERATORS:['INTpp','T1','T1','INTpp'],
                   IDX_SV   :[1,2,3,1],
                   FIX_VTX:True})

EXPAND_OP_PRODUCT({LABEL:'CCD_FORM_PP',NEW:False,OP_RES:'INTpp',FAC:1.0,
                   OPERATORS:['INTpp','T2','INTpp'],
                   IDX_SV   :[1,2,1],
                   FIX_VTX:True})
...
FACTOR_OUT({LABEL_RES:'CCD_FORM',LABEL_IN:'CCD_FORM',INTERM:'CCD_FORM_PP'})
...
OPTIMIZE({LABEL_OPT:'CCD_OPT',LABELS_IN:['CCD_FORM_PP','CCD_RES1','CCD_RES2','CCD_EN']})


TRANSLATE_ITF({LABEL: 'CCD_OPT',
               OUTPUT:'auicmrcc_ccsd.itfaa',
               TITLE: 'auicmrcc_ccsd.formulae',
               MULTI:False,
               TASKS:True,
               KEXT:True,
               ITIN:True})
