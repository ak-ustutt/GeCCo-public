...
c dbg
        call set_dependency(fopt_mpr12_0,mel_f12fix_def,tgt_info)
c dbg
      endif
c      endif
...
c dbg
      if(r12fix)
     &     call set_dependency(fopt_mpr12_0,'EVALINTS',tgt_info)
c dbg
...
c dbg
c      if(r12fix)then
c        call add_target('EVALINTS',ttype_gen,.false.,tgt_info)
c        call set_dependency('EVALINTS',mel_rint,tgt_info)
c        call set_dependency('EVALINTS',mel_c12def,tgt_info)
c        call set_dependency('EVALINTS',mel_f12fix,tgt_info)
c        call set_dependency('EVALINTS',fopt_f12int_fix,tgt_info)
c        labels(1:10)(1:len_target_name) = ' '
c        labels(1) = fopt_f12int_fix
c        call set_rule('EVALINTS',ttype_opme,EVAL,
c     &       labels,1,0,
