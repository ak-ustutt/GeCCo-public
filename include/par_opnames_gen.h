...
c dbg
     ...
     &     mel_dlpt0*7      = 'DL0(PT)',
     &     mel_dept0*7      = 'DE0(PT)',
     &     mel_dept0def*11  = 'DEF-DE0(PT)',
     &     mel_ham*2        = 'H0',
     &     mel_hhat*5       = 'H0hat',
     &     mel_hbar*5       = 'H0bar',
     &     mel_top*2        = 'T0',
     &     mel_tpt*6        = 'T(pt)0',
     &     mel_tptdef*10    = 'DEF-T(pt)0',
     &     mel_h0_tpt*6     = 'H0.T(pt)0',
     &     mel_h0_tptdef*10 = 'DEF-H0.T(pt)0',
     &     mel_tbar*2       = 'L0',
     &     mel_tbar_a*4     = 'L0.A',
     &     mel_eta*4        = 'ETA0',
     &     mel_etapt*8      = 'ETA(pt)0',
     &     mel_etaptdef*8   = 'DEF-ETA(pt)0',
     &     mel_omg*2        = 'O0',
     &     mel_omg_l*7      = 'O0_TBAR',
     &     mel_omg_t*4      = 'O0_T',
     ...
     &     meldef_ecclg0*11 = 'DEF-L0(ECC)',
     &     meldef_omg_l*11  = 'DEF-O0_TBAR',
     &     meldef_omg_t*8   = 'DEF-O0_T'
      character, parameter ::
     &     mel_rex*3        = 'RE0',
     ...
     &     mel_vp_inter*8    = 'U-INTER',
     &     mel_vp_def*12     = 'DEF-U-INTER',
