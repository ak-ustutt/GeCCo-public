      subroutine evp_control(modestr,iter,
...
*======================================================================*
      ifree = mem_setmark('evp_ctrl_temp')
      if (iter.ne.0) then
...
*======================================================================*
      if (iter.eq.0) then
         ifree = mem_setmark('evp_ctrl_perm')
         call leqevpc_init()
         task = 4
     ...
     &           call file_close_delete(opti_stat%ffext(iopt)%fhand)
         ...
         ifree = mem_flushmark('evp_ctrl_temp')
         return
...
! flush all other memory allocated by optimizer
         ifree = mem_flushmark('evp_ctrl_perm')
