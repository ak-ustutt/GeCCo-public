*----------------------------------------------------------------------*
      subroutine prop_evaluate(ndens,rank,idxden,
...
*----------------------------------------------------------------------*
     ...
     &       op_info%opfil_arr(idxden)%fhand,
     &       op_info%op_arr(idxden)%op,orb_info)
      else
      ...
      call oneprop_ao(ffdao,op_info%op_arr(idxden)%op,
     &     env_type,orb_info)
